...
- [ ] T004 [P] Set up environment variables for secrets

## Phase 3.2: Tests First (TDD) ⚠️ MUST COMPLETE BEFORE 3.3
**CRITICAL: These tests MUST be written and MUST FAIL before ANY implementation**
- [ ] T005 [P] Unit tests for API functions in tests/unit/test_api.py
...
- [ ] T022 [P] Update docs/api.md and README.md
- [ ] T023 Remove duplication
- [ ] T024 Run manual-testing.md
- [ ] T025 Add docstrings to all functions
